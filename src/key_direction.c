...
/*   Updated: 2023/05/26 15:33:09 by junhyupa         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{		
	if (data->cub.map[(int)(data->player.pos_y)][(int)(data->player.pos_x - (data->player.plane_x * (data->player.move_speed + 0.15)))] != '1')
		data->player.pos_x -= data->player.plane_x * data->player.move_speed;
	printf("%c\n",data->cub.map[(int)(data->player.pos_y + (data->player.dir_y * data->player.move_speed + 0.15))][(int)(data->player.pos_x)]);
	if (data->cub.map[(int)(data->player.pos_y - (data->player.plane_y * (data->player.move_speed + 0.15)))][(int)(data->player.pos_x)] != '1')
